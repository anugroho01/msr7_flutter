...
import 'package:msr_project/views/home_page.dart';
import 'package:msr_project/widgets/dialogs.dart';
...
class _PageLoginState extends State<PageLogin> {
  ...
  Widget inputEmail() {
    return TextFormField(
        ...
        autofocus: false,
        validator: (email) => email != null && email.length != 10
  ...
  doLogin(email, password) async {
    ...
    try {
      final response =
          await http.post(Uri.parse("http://127.0.0.1:5000/ceklogin"),
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        decoration: const BoxDecoration(
          ...
          colors: [Colors.redAccent, Color.fromARGB(255, 21, 236, 229)],
        )),
        child: Form(
          key: _formKey,
          child: ListView(
            children: [
              ClipPath(
                ...
                child: Container(
                  ...
                  height: 180,
                  decoration: const BoxDecoration(
                    color: Color.fromARGB(255, 255, 5, 43),
